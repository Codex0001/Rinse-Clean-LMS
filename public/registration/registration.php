...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                ...
                <a class="btn btn-primary" href="../login/login.php" role="button">Get Started</a>
            </div>
        </div>
    </nav>
    <!-- Nav bar ends here -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo isset($_SESSION['success']) ? $_SESSION['success'] : ''; ?></p>
                    </div>
        ...
        <div class="modal fade" id="errorModal" tabindex="-1" aria-labelledby="errorModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo isset($_SESSION['error']) ? $_SESSION['error'] : ''; ?></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
    ...
    <script>
    // Show modals if there are messages set in the session
