        ...
        <div class="menu">
            ...
            <ul class="menu-links">
                <li class="nav-link active">
                    <a href="../../staff/dashboard.php"> <!-- Updated link for staff dashboard -->
                ...
                <li class="nav-link">
                    <a href="../../staff/orders.php"> <!-- Updated link for staff orders -->
                        <i class='bx bx-list-alt icon'></i> <!-- You may want to change this icon -->
                        <span class="text nav-text">Orders</span>
                    </a>
                </li>

                <li class="nav-link">
                    <a href="../../staff/feedback_form.php"> <!-- Updated link for feedback form -->
